                ...
                <div class="col-md-12 navbar">
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item active" href="AdminViewCustomer.jsp">View Customer Details</a>
                ...
                <div class="row mx-auto">
                    <div class="col-md-12">
                        <div style="color: bisque">
                            ...
                            <h1 class="display-4 mt-5 py-5" style="text-align: center;">Admin View Customer</h1>
