...
//        out.println(fdesc);
            ...
            String query = "insert into fooditems(foodname,foodprice,foodcategory,foodtype,fooddesc) Values (?,?,?,?,?)";
            ...
            if (updateQuery > 0) {
                out.println("<script>alert('SuccessFully Added!!!!!');window.location.href='AddFood.jsp';</script>");
            } else {
                out.println("<script>alert('Some Error Occured....Please Try Again!!!!');window.location.href='AddFood.jsp';</script>");
            }
        } catch (Exception e) {
            out.println("<script>alert('Some Error Occured....Please Try Again!!!!');window.location.href='AddFood.jsp';</script>");
        }
